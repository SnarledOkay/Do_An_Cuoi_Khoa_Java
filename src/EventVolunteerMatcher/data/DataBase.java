...
public class DataBase {
    ...
    static {
        ...
        volunteerMenu.add("5 - Cancel participation for event");
        volunteerMenu.add("6 - View events you are joining");
        volunteerMenu.add("7 - View events that you had joined");
        volunteerMenu.add("8 - View events that you are hosting");
        volunteerMenu.add("9 - View events that you had hosted");
        volunteerMenu.add("10 - View requests to participate in your events");
        volunteerMenu.add("11 - Complete an event of yours");
        volunteerMenu.add("12 - Cancel an event");
        volunteerMenu.add("13 - Change personal information");
        volunteerMenu.add("14 - Report an user");
        volunteerMenu.add("15 - View community guidelines");
        volunteerMenu.add("16 - View account information");
        volunteerMenu.add("17 - Log out");
    }
