...
public class Menu {
    ...
    public void chooseChangeInformationMenu(Scanner scanner, int choice, Volunteer volunteer){
        switch (choice){
            case 1:
                System.out.print("Enter new username (enter 'exit' to escape): ");
                String username = scanner.nextLine() ;
                username = username.trim() ;
                while(utiles.checkUserNameExist(username)){
                    if(username.equals(volunteer.getUsername())) System.out.println("New username cannot be similar to current username");
            ...
            case 3:
                ...
                while(true){
                    ...
                    int chooseLocation = utiles.enterInteger(scanner);
                    if(chooseLocation < 0 || chooseLocation > DataBase.locationList.size()){
                        System.out.println("Invalid choice, please choose again");
                    }
                    else{
                        String location = DataBase.locationList.get(chooseLocation) ;
                        volunteer.setCurrentLocation(location);
                        break ;
                    }
                }
                System.out.println("Place of living has been saved");
                break;
            case 4:
                System.out.print("Enter new email (enter 'exit' to escape): ");
            ...
            case 5:
                while(true){
                    System.out.print("Enter ID code (enter 'exit' to escape): " );
                    String IDCode = scanner.nextLine() ;
                    if(IDCode.equalsIgnoreCase(volunteer.getSecretIdentification())){
                        System.out.println("ID code matched, please proceed");
                        break;
                    }
                    else if(IDCode.equalsIgnoreCase("exit")){
                        System.out.println("Process terminated");
                        return;
                    }
                    else{
                        System.out.println("ID code not matched");
                    }
                }
                String password ;
                while(true){
                ...
                while(true){
                    ...
                    if(password.equals(volunteer.getPassword())){
                        System.out.println("New password has to be different from former password");
                    }
                    else{
